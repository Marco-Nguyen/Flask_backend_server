...
from Flask.backend_server.Flask_backend_server.yolo_utils.utils import *
...
#     """RUN ONNX ENGINE"""
#     # weights_path = r"D:\Python\Pycharm\AI-in-agriculture\weights\Solar-car\new-data\yolov5s\best.onnx"
#     weights_path = r"D:\Python\Pycharm\AI-in-agriculture\weights\Smart-agriculture\updated-1.onnx"
#     webcam_id = 0
#     img_path = r"D:\Python\Pycharm\Flask\backend_server\Flask_backend_server\static\cucumber-4.jpg"
#     model = ONNX_engine()
#     print(model.run(weights=weights_path, source=img_path, view_img=False))
